...
class Order(models.Model):
    ...
    <div class="row justify-content-center" style="padding-bottom: 2rem;">
        ...
        <ul class="tab_title topbar" style="text-align:center;">
            <li class="on" id="menu_type--Premium">
                <h3 class="masthead-heading text-center mb-0" style="pointer-events: none; ">Premium</h3>
            </li>
            <li id="menu_type--bugger">
                <h3 class="masthead-heading text-center mb-0" style="pointer-events: auto; ">bugger</h3>
            </li>
            <li id="menu_type--Whopper">
                <h3 class="masthead-heading text-center mb-0" style="pointer-events: none; ">Whopper</h3>
            </li>
            <li id="menu_type--side">
                <h3 class="masthead-heading text-center mb-0" style="pointer-events: none; ">side</h3>
            </li>
              <li id="menu_type--drink">
                <h3 class="masthead-heading text-center mb-0" style="pointer-events: none; ">drink</h3>
            </li>
